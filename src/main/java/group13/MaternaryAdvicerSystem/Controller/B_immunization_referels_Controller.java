...
import group13.MaternaryAdvicerSystem.Service.Login.B_Immunization_Referels_Service;
...
public class B_immunization_referels_Controller {
    ...
    @GetMapping("/getbabyImmuneReferel/{babyNum}")
    public List<Save_Immunization_Referels_Dto> getBabyImmuneReferel(@PathVariable String babyNum){
        return b_immunization_service_referels_impl.getBabyImmuneReferels(babyNum);
    }
